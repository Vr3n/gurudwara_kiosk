        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This is the title of your journal.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This is the source of your journal.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This is the description of your journal.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
  ...
  return (
    <div className="w-full">
      ...
      <Input
        ...
        <Button
          onClick={openForm}
          className="ml-4 bg-blue-500 text-white py-3 px-4 rounded-md hover:bg-blue-600"
        >
          Add Journal
        </Button>
