...
const JournalDetailPage = () => {
  ...
  const journalId: string = router.query.id as string;
  ...
  if (isJournalLoading) return <p>Loading...</p>;

  if (journalError) return <p>Error loading the card...</p>;

  return (
    <div className="min-h-screen">
      <div className="flex flex-col justify-between">
        <div className="h-[90vh] overflow-y-scroll rounded-md border-2 border-zinc-300 p-8 shadow-md">
          <RenderHtml html={journal?.content ?? "<p>Loading...</p>"} />
        </div>
...
JournalDetailPage.getLayout = (page: any) => (
